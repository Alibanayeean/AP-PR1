...
import StudentController.ProfileStudent;
...
public class TeacherPageEducationalAssistant implements Initializable {
...
//            LocalTime currentTime = LocalTime.now();
    ...
    public void newUserMenuFunction(ActionEvent e) {
        try{
            Stage stage;
            stage = ((Stage)(((Scene)emailLabel.getScene()).getWindow()));
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("AddNewUser.fxml"));
            Parent root = loader.load();
            AddNewUser AddNewUser = loader.getController();
            AddNewUser.setTeacher(students ,teachers, courses, teacher);
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        }
    ...
    public void ProfileFunction(ActionEvent e) {
        try{
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("TeacherProfileEducationalAssistant.fxml"));
            Parent root = loader.load();
            TeacherProfileEducationalAssistant TeacherProfileEducationalAssistant = loader.getController();
            TeacherProfileEducationalAssistant.setTeacher(students ,teachers, teacher, courses);
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
        }
